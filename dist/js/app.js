...
},{"./lib/arr":2,"./lib/fn":3,"./lib/obj":4,"./lib/str":5}],2:[function(require,module,exports){
'use strict';
...
},{"iblokz-data":1,"snabbdom":17,"snabbdom/h":9,"snabbdom/modules/attributes":12,"snabbdom/modules/class":13,"snabbdom/modules/eventlisteners":14,"snabbdom/modules/props":15,"snabbdom/modules/style":16}],7:[function(require,module,exports){
...
},{"./is":11,"./vnode":19}],10:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./h":9,"./htmldomapi":10,"./is":11,"./thunk":18,"./vnode":19}],18:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
var h_1 = require("./h");
...
},{"./h":9}],19:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"iblokz-data":1}],21:[function(require,module,exports){
"use strict";
...
},{"./vector2":22}],22:[function(require,module,exports){
"use strict";
...
var _vector = require('../gfx/vector2');
...
var Canvas = function Canvas(dom) {
	_element2.default.call(this, dom);
...
Canvas.prototype = Object.create(_element2.default.prototype);
...
Canvas.prototype.text = function (text, position, options) {
	...
	if (!position) position = new _vector2.default(this.ctx.canvas.width / 2, this.ctx.canvas.height / 2);
...
},{"../gfx/vector2":22,"./element":24}],24:[function(require,module,exports){
"use strict";
...
var Element = function Element(dom) {
...
var Grid = function Grid(dom) {
	_canvas2.default.call(this, dom);
};

Grid.prototype = Object.create(_canvas2.default.prototype);
Grid.prototype.constructor = Grid;

Grid.prototype.refresh = function () {

	_canvas2.default.prototype.refresh.call(this);

	var ctx = this.ctx;

	var center = new _vector2.default(ctx.canvas.width / 2, ctx.canvas.height / 2);
	var sizeVector = new _vector2.default(ctx.canvas.width, ctx.canvas.height);
...
},{"../gfx/vector2":22,"./canvas":23}],26:[function(require,module,exports){
'use strict';
...
var _canvas = require('./gui/canvas');

var _canvas2 = _interopRequireDefault(_canvas);

var _grid = require('./gui/grid');
...
},{"./gfx/rect":21,"./gfx/vector2":22,"./gui/canvas":23,"./gui/element":24,"./gui/grid":25}],27:[function(require,module,exports){
'use strict';
...
History.prototype = {
	add: function add(undo, redo, title) {
		this.index++;
...
},{"./history":28,"./math":30}],30:[function(require,module,exports){
"use strict";
...
var BoxGeometry = function BoxGeometry(width, height, depth, widthSegments, heightSegments, depthSegments) {
	...
	this.buildQuads = function () {
		...
		// 2,3,1
		// left
		this.quads.push(new _quad2.default(this.vertices[0], this.vertices[1], this.vertices[3], this.vertices[2]));

		// 4,6,5
		// 6,7,5
		// right
		this.quads.push(new _quad2.default(this.vertices[4], this.vertices[5], this.vertices[7], this.vertices[6]));

		// 4,5,1
		// 5,0,1
		// top
		this.quads.push(new _quad2.default(this.vertices[4], this.vertices[1], this.vertices[0], this.vertices[5]));

		// 7,6,2
		// 6,3,2
		// bottom
		this.quads.push(new _quad2.default(this.vertices[7], this.vertices[2], this.vertices[3], this.vertices[6]));

		// 5,7,0
		// 7,2,0
		// front
		this.quads.push(new _quad2.default(this.vertices[5], this.vertices[0], this.vertices[2], this.vertices[7]));

		// 1,3,4
		// 3,6,4
		// back
		this.quads.push(new _quad2.default(this.vertices[1], this.vertices[4], this.vertices[6], this.vertices[3]));
	};
...
BoxGeometry.prototype.scale = function (_mod, scale2) {
	...
	if (params[modHelper[_mod.x]] + scale2.x * 2 < 5 || params[modHelper[_mod.y]] + scale2.y * 2 < 5) {
		scalePossible = false;
	}
	...
	this.vertices.forEach(function (_v, index) {
		...
		var objVector = new _vector2.default().copy(_v).toVector2(_mod);
...
BoxGeometry.prototype.clone = function (params) {
	...
	if (!params) params = this.parameters;

	var geometry = new BoxGeometry(params.width, params.height, params.depth, params.widthSegments, params.heightSegments, params.depthSegments);
...
},{"./quad":35,"./vector3":38}],32:[function(require,module,exports){
'use strict';
...
var _boxGeometry = require('./box-geometry');
...
exports.default = {
  ...
  Quad: _quad2.default,
  BoxGeometry: _boxGeometry2.default,
  Mesh: _mesh2.default,
  Scene: _scene2.default
};

},{"./box-geometry":31,"./interact":33,"./mesh":34,"./quad":35,"./scene":36,"./vector2":37,"./vector3":38}],33:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
	value: true
});
var move = function move(object3d, v3) {
	object3d.position.add(v3);
	object3d.updateMatrix();
};

var rotate = function rotate(object3d, v3) {
...
var scale = function scale(object3d, v3) {
...
var lookAt = function lookAt(object3d, v3) {
	object3d.lookAt(v3);
	object3d.updateMatrix();
};
...
var Quad = function Quad(a, b, c, d) {
...
Scene.prototype.selectNext = function (direction) {
	...
	while (!(nextToBeSelected && nextToBeSelected.id && nextToBeSelected.type == "Mesh") && iterations < this.children.length) {
		...
		if (direction == 1 && indexToBeSelected < this.children.length - 1 || direction == -1 && indexToBeSelected > 0) {
	...
	if (nextToBeSelected && nextToBeSelected.id && nextToBeSelected.type == "Mesh") this.selected = nextToBeSelected;
};
...
Scene.prototype.addBlock = function (_entity) {
	...
	var geometry = new _boxGeometry2.default(width, height, depth);
	...
	scene.children.forEach(function (child) {
		...
		if (child.type === "Mesh") {
			...
			if (geometry.type === "BoxGeometry") {
				geometry = new _boxGeometry2.default().clone(geometry.parameters);
			}
			var mesh = new _mesh2.default(geometry, material);
			child.updateMatrix();
...
},{"./box-geometry":31,"./mesh":34}],37:[function(require,module,exports){
'use strict';
...
Vector3.prototype.toVector2 = function (mod) {
	...
	var v2 = new _vector2.default(this[mod.u] * mod.xD, this[mod.v] * mod.yD);
...
},{"./vector2":37}],39:[function(require,module,exports){
'use strict';
...
var _iblokz = require('../../iblokz');

var _iblokz2 = _interopRequireDefault(_iblokz);
...
var _view3d = require('./view3d');

var _view3d2 = _interopRequireDefault(_view3d);

var _view2d = require('./view2d');

var _view2d2 = _interopRequireDefault(_view2d);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Editor = function Editor(_views, _entities) {

	_element2.default.call(this, 'body');

	this.params = {
		"obj-mode": "move"
	};

	this.history = new _etc2.default.History();
	...
	// init scene
	this.scene = new _ext2.default.Scene();
	...
	for (var key in _views) {
		...
		switch (viewConf.perspective) {
			case "3d":
				this.views.push(new _view3d2.default(viewConf, this.scene, this));
				break;
			default:
				this.views.push(new _view2d2.default(viewConf, this.scene, this));
				break;
		}
	}
	...
	this.panel = new _panel2.default(".panel.left", this);
	this.toolbar = new _toolbar2.default(".toolbar", this);

	this.scene.addEntities(_entities);
};

Editor.prototype = Object.create(_element2.default);
...
Editor.prototype.init = function () {
  ...
  */
	...
	dom.addEventListener("keyup", function (event) {
		...
		var focusedElements = [].slice.call(dom.querySelectorAll(':focus'));

		// desselect and blur on esc
		if (keyCode == 27) {
			if (focusedElements.length > 0) {
				focusedElements.map(function (el) {
					return el.blur();
				});
			} else {
...
Editor.prototype.changeMode = function (mode) {
	if (this.params['obj-mode'] !== mode) {
		...
		[].slice.call(dom.querySelectorAll("a.obj-mode-option[data-option-param='obj-mode']")).map(function (el) {
...
Editor.prototype.interact = function (action, v3) {
	...
	// apply action
	_ext2.default.interact[action](selected, v3);
...
Editor.prototype.selectView = function (view) {
	...
	[].slice.call(this.dom.querySelectorAll('.views .view')).map(function (el) {
		return el.classList.remove('selected');
	});
...
Editor.prototype.cloneObject = function () {
	...
	if (!this.scene.selected) return false;
...
Editor.prototype.updateObject = function (objId) {
	...
	// rotation
	selected.rotation.x = _etc2.default.math.radians(parseInt(dom.querySelector("#object-pane-rotation-x").value));
	selected.rotation.y = _etc2.default.math.radians(parseInt(dom.querySelector("#object-pane-rotation-y").value));
	selected.rotation.z = _etc2.default.math.radians(parseInt(dom.querySelector("#object-pane-rotation-z").value));
...
Editor.prototype.refreshObjectPane = function () {
	if (this.scene.selected) {
		...
		// rotation
		this.dom.querySelector("#object-pane-rotation-x").value = parseInt(_etc2.default.math.degrees(this.scene.selected.rotation.x));
		this.dom.querySelector("#object-pane-rotation-y").value = parseInt(_etc2.default.math.degrees(this.scene.selected.rotation.y));
		this.dom.querySelector("#object-pane-rotation-z").value = parseInt(_etc2.default.math.degrees(this.scene.selected.rotation.z));
...
},{"../../iblokz":26,"../etc":29,"../ext":32,"./element":40,"./panel":42,"./toolbar":43,"./view2d":44,"./view3d":45,"rx":8}],40:[function(require,module,exports){
'use strict';
...
var Element = function Element(dom, context) {
...
Element.prototype.init = function () {
	...
	[].slice.call(dom.querySelectorAll('[class*=\'-toggle\']')).map(function (el) {
		return _rx.Observable.fromEvent(el, 'click').map(function () {
...
},{"rx":8}],41:[function(require,module,exports){
'use strict';
...
exports.default = {
  ...
  View3D: _view3d2.default,
  View2D: _view2d2.default,
  Editor: _editor2.default
};

},{"./editor":39,"./element":40,"./panel":42,"./toolbar":43,"./view2d":44,"./view3d":45}],42:[function(require,module,exports){
'use strict';
...
Panel.prototype.refresh = function () {
	...
	var meshEntities = dom.querySelector('.entities#mesh-entities');

	// clean up the entities list
	while (meshEntities.firstChild) {
		meshEntities.removeChild(meshEntities.firstChild);
		...
		if (entity.type === "Mesh") {
			_rx.Observable.fromEvent(el, 'click').map(function () {
				return context.select(parseInt(el.getAttribute("data-obj-id")));
			}).subscribe();
		}
...
},{"./element":40,"rx":8}],43:[function(require,module,exports){
'use strict';
...
Toolbar.prototype = Object.create(_element2.default);
...
Toolbar.prototype.init = function () {
	...
	[].slice.call(dom.querySelectorAll('.indexes')).map(function (el) {
		return _rx.Observable.fromEvent(el, 'change').map(function () {
...
},{"./element":40,"rx":8}],44:[function(require,module,exports){
'use strict';
...
var View2D = function View2D(_conf, _scene, _editor) {

	_element2.default.call(this, _conf.dom);
	//this.ctx = this.canvas.getContext("2d");

	var dom = this.dom;

	this.layers = {
		grid: new _iblokz2.default.gui.Grid(dom.querySelector('.grid-layer')),
		scene: new _iblokz2.default.gui.Canvas(dom.querySelector('.scene-layer')),
		selection: new _iblokz2.default.gui.Canvas(dom.querySelector('.selection-layer')),
		indicators: new _iblokz2.default.gui.Canvas(dom.querySelector('.indicators-layer'))
	};
	...
	this.center = new _ext2.default.Vector2(dom.clientWidth / 2, dom.clientHeight / 2);

	this.zoom = 100;
	this.offset = new _ext2.default.Vector2(0, 0);
	...
	var handleSelect = function handleSelect(ev) {
		...
		var hitPos = new _ext2.default.Vector2(ev.offsetX, ev.offsetY);
		...
		_view.hitFaces.forEach(function (hitFace) {
			if (hitFace.triangle.containsPoint(hitPos.toVector3(_view.mod))) {
				...
				if (selected === false || hitFace.position[_view.mod.w] > selected.position[_view.mod.w]) {
					...
					if (hitFace.objId === old.objId) return true;
	...
	this.interaction = {
		status: "idle",
		start: new _ext2.default.Vector2(0, 0),
		last: new _ext2.default.Vector2(0, 0),
		button: 0
	};

	// mouse move
	_rx.Observable.fromEvent(dom, 'mousedown').map(function (ev) {
	...
	_rx.Observable.fromEvent(dom, 'touchstart').map(function (ev) {
	...
	_rx.Observable.fromEvent(dom, 'mousemove').map(function (ev) {
		if (["mousedown", "mousemove"].indexOf(_view.interaction.status) > -1) {
			_view.interaction.status = "mousemove";

			var mousePos = new _ext2.default.Vector2(ev.offsetX, ev.offsetY);
			...
			switch (_view.interaction.button) {
				...
				case 0:
					if (_view.selected === false) return;
	...
	_rx.Observable.fromEvent(dom, 'touchmove').map(function (ev) {
		var e = ev.originalEvent;
		ev.preventDefault();
		if (["mousedown", "mousemove"].indexOf(_view.interaction.status) > -1) {
			_view.interaction.status = "mousemove";

			var mousePos = new _ext2.default.Vector2(e.touches[0].clientX, e.touches[0].clientY);
	...
	_rx.Observable.fromEvent(dom, 'mouseup').map(function (ev) {
		if (ev.button == 0 && (_view.interaction.status === "mousedown" || _view.interaction.last.toArray() == [0, 0])) {
			handleSelect(ev);
		}
		_view.interaction = {
			status: "idle",
	...
	_rx.Observable.fromEvent(dom, 'touchend').map(function (ev) {
		var e = ev.originalEvent;
		if (_view.interaction.status === "mousedown" || _view.interaction.last.toArray() == [0, 0]) {
			var hitPos = new _ext2.default.Vector2(e.touches[0].clientX, e.touches[0].clientY);
			handleSelect(hitPos);
		}
		_view.interaction = {
			status: "idle",
	...
	_rx.Observable.fromEvent(dom, 'wheel').map(function (ev) {
...
View2D.prototype = Object.create(_element2.default.prototype);
...
View2D.prototype.drawObject = function (canvas, obj, _lineDash, _strokeStyle, _showCoords) {
	...
	var scaleVector = new _ext2.default.Vector3().copy(obj.scale);
	var center2 = this.center.clone().add(scope.offset);

	var objPos3 = new _ext2.default.Vector3().copy(obj.position);

	var objCenter2 = objPos3.clone().toVector2(_mod).add(center2);

	var transformVectorTo2DCanvas = function transformVectorTo2DCanvas(v3) {
		return new _ext2.default.Vector3().copy(v3).multiply(scaleVector).applyEuler(obj.rotation).add(objPos3).toVector2(_mod).multiplyScalar(scope.zoom / 100).add(center2);
	};
   ...
   ctx.closePath();*/
			...
			scope.hitFaces.push({
				triangle: new THREE.Triangle(quad2d.a.toVector3(_mod), quad2d.b.toVector3(_mod), quad2d.c.toVector3(_mod)),
				position: obj.position.clone(),
				objId: obj.id
			});
			scope.hitFaces.push({
				triangle: new THREE.Triangle(quad2d.b.toVector3(_mod), quad2d.c.toVector3(_mod), quad2d.d.toVector3(_mod)),
				position: obj.position.clone(),
				objId: obj.id
			});
			...
			if (_showCoords) {
				...
				if (scope.editor.indexes.length === 0 || scope.editor.indexes.indexOf(index + "") > -1) {
					ctx.fillText("a(" + new _ext2.default.Vector3().copy(_quad.a).toVector2(_mod).toArray().join(", ") + "), " + quad2d.a.toArray().join(", "), quad2d.a.x, quad2d.a.y);
					ctx.fillText("b(" + new _ext2.default.Vector3().copy(_quad.b).toVector2(_mod).toArray().join(", ") + "), " + quad2d.b.toArray().join(", "), quad2d.b.x, quad2d.b.y);
					ctx.fillText("c(" + new _ext2.default.Vector3().copy(_quad.c).toVector2(_mod).toArray().join(", ") + "), " + quad2d.c.toArray().join(", "), quad2d.c.x, quad2d.c.y);
					ctx.fillText("d(" + new _ext2.default.Vector3().copy(_quad.d).toVector2(_mod).toArray().join(", ") + "), " + quad2d.d.toArray().join(", "), quad2d.d.x, quad2d.d.y);
				}
				_indexes.push(index);
		...
		obj.geometry.faces.forEach(function (face, index) {
			...
			scope.hitFaces.push({
				triangle: new THREE.Triangle(face2d.a.toVector3(_mod), face2d.b.toVector3(_mod), face2d.c.toVector3(_mod)),
				position: obj.position.clone(),
				objId: obj.id
			});
		});
...
View2D.prototype.refresh = function (scene) {
  ...
  */
	...
	// draw indicators
	this.layers.indicators.text(this.perspective, new _iblokz2.default.gfx.Vector2(15, 25), { font: "16px Arial", color: "#999" });
	this.layers.indicators.text(this.zoom, new _iblokz2.default.gfx.Vector2(this.layers.indicators.ctx.canvas.width - 65, 25), { font: "14px Arial", color: "#999" });
	this.layers.indicators.text(this.offset.toArray().join(", "), new _iblokz2.default.gfx.Vector2(this.layers.indicators.ctx.canvas.width - 65, this.layers.indicators.ctx.canvas.height - 15), { font: "12px Arial", color: "#999" });

	this.center.set(dom.clientWidth / 2, dom.clientHeight / 2);
...
},{"../../iblokz":26,"../ext":32,"./element":40,"rx":8}],45:[function(require,module,exports){
'use strict';
...
var View3D = function View3D(conf, scene, editor) {
	_element2.default.call(this, conf.dom);
...
View3D.prototype = Object.create(_element2.default.prototype);
...
View3D.prototype.addBlock = function (entity) {
	...
	var geometry = new _ext2.default.BoxGeometry(width, height, depth);
	var color = entity.color || 0x777777;
	var material = new THREE.MeshBasicMaterial({ color: color, wireframe: false });
	var mesh = new _ext2.default.Mesh(geometry, material);
	mesh.position.set(pos.x, pos.y, pos.z);
	mesh.receiveShadow = true;
	mesh.castShadow = true;
...
},{"../ext":32,"./element":40}],46:[function(require,module,exports){
"use strict";
...
},{"./etc":29,"./ext":32,"./gui":41}],47:[function(require,module,exports){
'use strict';
...
module.exports = function (_ref) {
  ...
  return section('.toolbar', [div('.logo', 'QooleJS'), a('.panel-toggle.fa.fa-bars.toggled', { attrs: {
      'data-toggle-ref': '.panel.left',
      'data-toggle-class': 'opened'
    } }), div('.left-bar', leftBarTools.map(function (tool) {
    return fn.switch(tool.type, {
      ...
      trigger: function trigger() {
        return a('.' + str.fromCamelCase(tool.method, '-') + '-trigger', {
          attrs: {
